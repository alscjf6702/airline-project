							...
							<input type="hidden" name = "command" value="user_list"/>
								...
								<div class="form-group tm-form-group tm-form-group-pad tm-form-group-1">
									<div class="form-group tm-form-group tm-form-group-pad tm-form-group-3">
										<label for="type">검색조건</label> 
										<select name="type" class="form-control tm-select" id="type">
									...
									<div class="form-group tm-form-group tm-form-group-pad tm-form-group-1" >
										...
										<input name="keyword" type="text" class="form-control" id="keyword" placeholder="현재 아이디만 가능">
									</div>
						...
						<c:forEach items="${pagelist}" var="list">
							<tbody>
								<tr>
									...
									<td><button type="button" class="btn btn-primary onclick="location.href='UserServlet?command=userDelete&userid=${list.userid}'">삭제</button></td>
								</tr>
							</tbody>
						</c:forEach>
					</table>
